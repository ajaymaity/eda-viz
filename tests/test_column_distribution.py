...
from tests.test_data import CATEGORICAL_LIST, CATEGORICAL_NUMPY, \
    ...
    CATEGORICAL_AND_NUMERICAL_LIST, CATEGORICAL_NUMERICAL_AND_DICTIONARY_LIST, \
    DICTIONARY_LIST, RANDOM_NUMBER, RANDOM_STRING, RANDOM_DICTIONARY, \
    EMPTY_STRING, NONE, NUMPY_NAN, NUMPY_INF, EMPTY_LIST, ALL_NONE_LIST, \
    RANDOM_TITLE, RANDOM_XLABEL, RANDOM_YLABEL  # noqa: E402
